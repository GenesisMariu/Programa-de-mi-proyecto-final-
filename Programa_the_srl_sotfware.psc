 Proceso SistemaDeFacturacion
		Escribir Sin Saltar "Ingresa el codigo del producto:";
		...
		Escribir Sin Saltar "Ingresa el valor de porcentaje de impuesto:";
		Leer porcentaje_de_impuesto;
		Escribir Sin Saltar "Ingresa el valor de precio unidad:";
		Leer precio_unidad;
